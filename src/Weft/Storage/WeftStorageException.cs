...
/// </summary>
public class WeftStorageException : Exception
{
    public WeftStorageException(string message)
        : base(message)
    {
    }

    public WeftStorageException(string message, Exception innerException)
...
/// </summary>
public sealed class WeftConcurrencyException(string message) : WeftStorageException(message);
...
/// </summary>
public sealed class WeftParentJobNotFoundException(JobId parentId)
    : WeftStorageException($"Continuation parent job '{parentId}' does not exist.")
{
