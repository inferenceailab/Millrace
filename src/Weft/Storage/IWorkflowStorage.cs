...
{
    /// <summary>Stores a new instance with <c>Revision = 1</c>; duplicate id throws <see cref="WeftConcurrencyException"/>.</summary>
    ...
    /// <summary>
    /// Optimistic-concurrency replace: throws <see cref="WeftConcurrencyException"/> unless the
