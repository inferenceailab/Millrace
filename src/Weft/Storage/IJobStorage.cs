...
/// cron) lives in the engine. The conformance kit in <c>Weft.Storage.Verification</c> enforces
...
public interface IJobStorage
{
    ...
    /// <see cref="WeftParentJobNotFoundException"/> (and the whole batch rolls back). The
