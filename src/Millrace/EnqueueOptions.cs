...
{
    /// <summary>Target queue; defaults to <see cref="MillraceOptions.DefaultQueue"/>.</summary>
    public string? Queue { get; init; }

    /// <summary>Higher priority is claimed first; FIFO within equal priority. Default 0.</summary>
    public int Priority { get; init; }

    /// <summary>Retry policy; defaults to <see cref="MillraceOptions.DefaultRetry"/>.</summary>
